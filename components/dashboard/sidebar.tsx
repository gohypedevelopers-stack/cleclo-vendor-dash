  ...
  return (
    ...
    >
      ...
      <div className="space-y-4 px-3">
        <div className="py-2">
          <div className={cn("flex items-center mb-8 h-12", isCollapsed ? "justify-center" : "gap-2")}>
             {/* Logo Section */}
             {isCollapsed ? (
                ...
                <div className="flex flex-col gap-1 items-center w-full">
                   ...
                   <span className="text-xs text-[#3E8940] font-bold tracking-wider uppercase text-center">Vendor Portal</span>
                </div>
             )}
          </div>
